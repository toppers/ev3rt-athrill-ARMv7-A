...
#define TNUM_STSKID	7

const ID _kernel_tmax_tskid = (TMIN_TSKID + TNUM_TSKID - 1);
const ID _kernel_tmax_stskid = (TMIN_TSKID + TNUM_STSKID - 1);

static STK_T _kernel_stack_EV3_INIT_TASK[COUNT_STK_T(STACK_SIZE)];
static STK_T _kernel_stack_BRICK_BTN_TSK[COUNT_STK_T(STACK_SIZE)];
static STK_T _kernel_stack_APP_INIT_TASK[COUNT_STK_T(STACK_SIZE)];
static STK_T _kernel_stack_LOGTASK[COUNT_STK_T(LOGTASK_STACK_SIZE)];
static STK_T _kernel_stack_BALANCE_TASK[COUNT_STK_T(STACK_SIZE)];
static STK_T _kernel_stack_MAIN_TASK[COUNT_STK_T(STACK_SIZE)];
static STK_T _kernel_stack_IDLE_TASK[COUNT_STK_T(STACK_SIZE)];

const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	{ (TA_ACT), (intptr_t)(0), ((TASK)(ev3_main_task)), INT_PRIORITY(TPRI_INIT_TASK), ROUND_STK_T(STACK_SIZE), _kernel_stack_EV3_INIT_TASK, (TA_NULL), (NULL) },
	{ (TA_NULL), (intptr_t)(0), ((TASK)(brick_button_task)), INT_PRIORITY(TMIN_APP_TPRI), ROUND_STK_T(STACK_SIZE), _kernel_stack_BRICK_BTN_TSK, (TA_NULL), (NULL) },
	{ (TA_ACT), (intptr_t)(0), ((TASK)(_app_init_task)), INT_PRIORITY(TPRI_APP_INIT_TASK), ROUND_STK_T(STACK_SIZE), _kernel_stack_APP_INIT_TASK, (TA_NULL), (NULL) },
	...
	{ (TA_NULL), (intptr_t)(0), ((TASK)(balance_task)), INT_PRIORITY(TMIN_APP_TPRI), ROUND_STK_T(STACK_SIZE), _kernel_stack_BALANCE_TASK, (TA_NULL), (NULL) },
	{ (TA_ACT), (intptr_t)(0), ((TASK)(main_task)), INT_PRIORITY(TMIN_APP_TPRI + 1), ROUND_STK_T(STACK_SIZE), _kernel_stack_MAIN_TASK, (TA_NULL), (NULL) },
	{ (TA_NULL), (intptr_t)(0), ((TASK)(idle_task)), INT_PRIORITY(TMIN_APP_TPRI + 2), ROUND_STK_T(STACK_SIZE), _kernel_stack_IDLE_TASK, (TA_NULL), (NULL) }
};
...
const ID _kernel_torder_table[TNUM_STSKID] = {
	EV3_INIT_TASK, BRICK_BTN_TSK, APP_INIT_TASK, LOGTASK, BALANCE_TASK, MAIN_TASK, IDLE_TASK
};
...
const CYCINIB _kernel_cycinib_table[TNUM_SCYCID] = {
	{ (TA_NULL), (intptr_t)(0), (brick_button_cyc), (10), (0) }
};
